...
$rendu=filter_input(INPUT_POST,'rendu',257);
...
if(filter_input(INPUT_POST, 'Search')){
    if($idDemandeau) {
        if($rendu==2){
            ...
            $Cadeaux=get("*",'grm_demande_cadeaux',array('id_demandeur='=>$idDemandeau,'point_bonus>'=>0,'date_remise_point>='=>$de,'date_remise_point<='=>$a,'etat_bs='=>$rendu),'AND',array('id'=>'ASC'));
        ...
        if($rendu==2){
            ...
            $Cadeaux=get("*",'grm_demande_cadeaux',array('famille='=>10,'date_remise_point>='=>$de,'date_remise_point<='=>$a,'etat_bs='=>$rendu),'AND',array('id'=>'ASC'));
            ...
            <div class="box box-success box-body table-responsive">
                <div class="form-inline" style="width: 100%;padding-bottom: 3%;">
                    <form class="form" method="POST" action="#">
                        ...
                        <label>Rendu </label>
                        <select class="form-control" name="rendu"  id="rendu" >
                            <option value="2"<?if($rendu==2){echo 'selected';}?>>Tous </option>
                            <option value="1" <?if($rendu==1){echo 'selected';}?>>Oui </option>
                            <option value="0" <?if($rendu==0){echo 'selected';}?>>non </option>
                ...
                <?php if($Cadeaux){?>
                    <br/>
                    <button type="button"  onclick="toexcelv2('cagro','etat bs')"
                            class="btn btn-primary pull-right" >Extraction</button>
                    <br>
                    <table class="table table-bordered table-condensed" name="budgq" id="budgq">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>date remise</th>
